...
import solution.ProcessRickartAgrawala;
...
public class ProcessRickartAgrawalaTest {
    private TestSystem testSystem;

    private void initProcs(int nProcs, Supplier<MessageBus> messageBusBuilder) {
        testSystem = new TestSystem(nProcs, 100, ProcessRickartAgrawala::new, messageBusBuilder);
    }
